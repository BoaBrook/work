 ...
 * @date 2026-01-14
 */
@TableName(value = "t_fire_gas_host_base_info", autoResultMap = true)
@Data
@EqualsAndHashCode(callSuper = true)
public class TFireGasHostBaseInfo extends BaseEntity {
