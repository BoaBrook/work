package cn.stylefeng.guns.modular.hikvision.Commom;
...
public class CommonMethod {
    ...
    public static String getResFileAbsPath(String filePath) {
        ...
        // 获取操作系统名称（统一转为小写，避免大小写判断问题）
        String osName = System.getProperty("os.name").toLowerCase();
        // 判断操作系统类型并拼接路径
        if (osName.contains("windows")) {
            // Windows系统路径
            return System.getProperty("user.dir") + "\\guns-8.1.2-backend\\src\\main\\resources\\" + filePath;
        } else{
            // Linux系统路径
            return "/service/app/jsonfile/" + filePath;
        }
    }
